/*1431734792,,JIT Construction: v1739814,hu_HU*/
...
try {
	window.FB || (function(window) {
		...
		(function() {
			var a = {},
			    ...
			    c = function(i, j) {
				return b(i && /^[A-Z]/.test(i) ? i : (
				void 0), j && ((j.params && j.params.length) || j.returns) ? 'function(' + (j.params ? j.params.map(function(k) {
					return (/\?/).test(k) ? '?' + k.replace('?', '') : k;
				}).join(',') : '') + ')' + (j.returns ? ':' + j.returns : '') : (
				void 0));
			},
			    d = function(i, j, k) {
				return i;
					...
					if (!m) {
						...
						q = function(ga, ha, ia, ja, ka, la, ma) {
							...
							if ( typeof na == "object") {
								...
								if (oa == "[object Array]") {
									for ( za = 0,
									ab = na.length; za < ab; cb || ( cb = true), za++) {
						...
						k.stringify = function(ga, ha, ia) {
							...
							if ( typeof ha == "function" || typeof ha == "object" && ha)
								if (g.call(ha) == "[object Function]") {
									...
									la = {};
									for ( ma = 0,
									na = ha.length; ma < na; oa = ha[ma++], ((g.call(oa) == "[object String]" || g.call(oa) == "[object Number]") && (la[oa] = 1)));
								}
							if (ia)
					...
					if (!r) {
						...
						k.parse = function(ga, ha) {
							...
							if (v() != "$")
								u();
							z = aa = null;
							return ha && g.call(ha) == "[object Function]" ? x(( ba = {}, ba[""] =
							ia, ba), "", ha) : ia;
						};
					}
				}
		...
		__d("JSSDKXDConfig", [], {
			...
			"XdBundleUrl" : "\/connect\/xd_arbiter\/NM7BtzAR8RM.js?version=41",
			"Flash" : {
		...
		__d("sdk.Auth", ["sdk.Cookie", "sdk.createIframe", "DOMWrapper", "sdk.feature", "sdk.getContextType", "guid", "sdk.Impressions", "Log", "ObservableMixin", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "sdk.URI", "sdk.XD"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
			...
			function aa(da) {
				...
				var ga = z(da, u, 'login_status'),
				    ha = new s(r.resolve('www', true) + '/connect/ping').setQueryData({
		...
		__d("ApiClient", ["ArgumentError", "Assert", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "sprintf", "sdk.URI", "UrlMap", "ApiClientConfig", "invariant"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
			...
			function ma() {
				...
				var ua = ka(ra),
				    ...
				    za = {
					method : ya,
					relative_url : va.removeQueryData('method').toString()
				};
			...
			function na() {
				...
				if (ra.length === 1) {
					var ta = ra[0],
					    ua = sa[0],
					    va = ta.body ? o.decode(ta.body) : null;
			...
			function oa(ra, sa) {
				...
				ra.api_key = v;
				var ua = ta in z ? 'api_read' : 'api',
				    va = r.resolve(ua) + '/restserver.php',
				    wa = ES(ja, 'bind', true, null, sa, '/restserver.php', 'get', ra, ES('Date', 'now', false));
				ia(va, 'get', ra, wa);
			}

			var pa = ES('Object', 'assign', false, new n(), {
				setAccessToken : function(ra) {
					u = ra;
				},
		...
		__d("sdk.Dialog", ["sdk.Canvas.Environment", "sdk.Content", "sdk.DOM", "DOMEventListener", "ObservableMixin", "sdk.Runtime", "Type", "sdk.UA", "sdk.fbt", "sdk.feature"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
			...
			var w = m.extend({
				...
				_createMobileLoader : function() {
					var y = n.nativeApp() ? '' : ('<table>' + '  <tbody>' + '    <tr>' + '      <td class="header_left">' + '        <label class="touchable_button">' + '          <input type="submit" value="' + o._("M\u00e9gsem") + '"' + '            id="fb_dialog_loader_close"/>' + '        </label>' + '      </td>' + '      <td class="header_center">' + '        <div>' + '         ' + o._("Bet\u00f6lt\u00e9s...") + '        </div>' + '      </td>' + '      <td class="header_right">' + '      </td>' + '    </tr>' + '  </tbody>' + '</table>');
					return x.create({
			...
			var ha = {
				...
				prepareCall : function(ia, ja) {
					...
					ES('Object', 'assign', false, ia, {
						...
						locale : q.getLocale(),
						sdk : 'joey',
						access_token : na && q.getAccessToken() || (
						void 0)
					});
					...
					if (sa === 'parent')
						ES('Object', 'assign', false, pa.params, {
				...
				iframe : function(ia) {
					...
					ia.root = j.create({
						onClose : ja,
						closeIcon : ia.closeIcon === (
						void 0) ? true : ia.closeIcon,
		...
		__d("IframePlugin", ["sdk.Auth", "sdk.DOM", "sdk.Event", "Log", "ObservableMixin", "sdk.PlatformVersioning", "PluginPipe", "QueryString", "sdk.Runtime", "Type", "sdk.UA", "sdk.URI", "UrlMap", "sdk.XD", "sdk.createIframe", "sdk.feature", "guid", "resolveURI"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x) {
			...
			var ba = {
				...
				bool : function(ha) {
					return ha ? (/^(?:true|1|yes|on)$/i).test(ha) : (
					void 0);
				},
				url : function(ha) {
					return x(ha);
				...
				px : function(ha) {
					return (/^(\d+)(?:px)?$/).test(ha) ? parseInt(RegExp.$1, 10) : (
					void 0);
				},
				text : function(ha) {
					return ha;
			...
			function ca(ha, ia) {
				var ja = ha[ia] || ha[ia.replace(/_/g, '-')] || ha[ia.replace(/_/g, '')] || ha['data-' + ia] || ha['data-' + ia.replace(/_/g, '-')] || ha['data-' + ia.replace(/_/g, '')] || (
				void 0);
				return ja;
			}
			...
			function ea(ha) {
				if (ha === '100%')
					return '100%';
				return ha || ha === '0' || ha === 0 ? parseInt(ha, 10) : (
				void 0);
			}
			...
			var ga = p.extend({
				constructor : function(ha, ia, ja, ka) {
					...
					this._iframeOptions = {
						...
						url : na + n.encode(oa),
						name : pa,
						width : this._config.mobile_fullsize && q.mobile() ?
						void 0 : oa.width || 1000,
				...
				reposition : function(ha) {
					var ia = h.getPosition(this._iframe).x,
					    ja = h.getViewportInfo().width,
	...
	new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1739814","message":"' + e.message + '"}}');
}